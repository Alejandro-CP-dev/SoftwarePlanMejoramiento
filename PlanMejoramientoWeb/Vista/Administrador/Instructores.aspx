...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="modal fade" id="modalAsignarFicha" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>Asignar Ficha a Instructor</h5>
                </div>
                <div class="modal-body">
                    <span class="modal-label">Instructor</span>
                    <asp:Label ID="lblInstructor" runat="server" CssClass="modal-name" />
    ...
    <div class="pg-title">Gestión de Instructores</div>
    <div class="pg-subtitle">Registra, edita y asigna fichas a instructores</div>

    <%-- Formulario --%>
    <div class="card">
        <div class="card-title">Datos del instructor</div>
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <asp:TextBox ID="txtCorreo" runat="server" TextMode="Email" placeholder="correo@sena.edu.co" />
            </div>
